        ...
        return (
            <section>
                ...
                <div id="playlistContainer" style={{ display: 'flex', margin: '1rem' }}>
                    <iframe title="playlist1" className="playlists" style={{ marginLeft: 'auto', marginRight: 'auto' }} src="https://www.youtube.com/embed/?listType=playlist&list=PL9ieIw6nXWjJZJzJXrIJuol-JHgDpWUIV" frameBorder="5" allowFullScreen></iframe>
