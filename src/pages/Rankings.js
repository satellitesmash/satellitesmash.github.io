    ...
    render() {
        return (
            <section id="ranking-page">
                ...
                <p>The current season runs from 6/1/19 - 8/31/19. Head out to some <Link to="/events">Events</Link> for a shot at making the list!</p>
                <h3>Spring 2019</h3>
                <div className="rankings-image">
                    <img style={{ width: '100%' }} src={require('../assets/sprPR19.jpg')} alt="Spring PR 2019"></img>
                </div>
            </section>
        );
    }
